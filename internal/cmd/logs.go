...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View RevoCLI logs",
	Long:  `View the logs generated by RevoCLI. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.WorkingDir(), cfg.Options.DataDirectory, "logs", "revocli.log")
